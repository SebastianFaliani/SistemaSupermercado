...
export async function obtenerReporte({ fecha_desde: desde, fecha_hasta: hasta }) {
  ...
  const [[resumen], [porDia], [productos], [categorias], [medios], [credito], [deuda]] = await Promise.all([
